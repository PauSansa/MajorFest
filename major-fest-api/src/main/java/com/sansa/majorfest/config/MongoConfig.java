...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        String dbName = System.getenv().get("MONGO_DB_DATABASE");
        if(dbName == null){
    ...
    public MongoClient mongoClient() {
        ...
        String mongoDbUrl = System.getenv().get("MONGO_DB_URL");
        String username = System.getenv().get("MONGO_DB_USERNAME");
        String password = System.getenv().get("MONGO_DB_PASSWORD");
